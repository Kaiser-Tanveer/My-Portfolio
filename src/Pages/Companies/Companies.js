...
const Companies = () => {
    return (
        <div className='mb-24 w-5/6 mx-auto'>
             <h1 className='pb-10 text-white text-5xl text-left font-bold'>EXPERIENCES</h1>
             <div className="mx-auto p-10 rounded-lg text-white border-2 border-emerald-500" style={{ boxShadow: '2px 3px 12px rgb(16, 185, 129)' }}>
